...
One of the services, *helloservice*, shows how to use JavaScript based microservice with Skipper. This allows to use containers with various programming languages - Python, JavaScript, Go, Java, etc. You can run ML services with Python frameworks, Node.js or any other choice.
